...
namespace MFM {
  ...
  void UlamRef_Test::Test_UlamRefRead()
  {
...

    {
      AtomBitStorage<TestEventConfig> t(setup());
      {
        TestUlamRef ur(16, 24, 0, t, 0);
        assert(ur.Read() == 0x432144);
      }
      {
        TestUlamRef ur(4, 32, 0, t, 0);
        assert(ur.Read() == 0x76543214);
      }
      {
        TestUlamRef ur(32+16, 20, 0, t, 0);
        assert(ur.Read() == 0x2211f);
      }
      {
        TestUlamRef ur(28, 4, 0, t, 0);
        assert(ur.Read() == 0x1);
      }
      {
        TestUlamRef ur(32*2 - 8, 8, 0, t, 0);
        assert(ur.Read() == 0x11);
      }
    }
  }
  ...
  void UlamRef_Test::Test_UlamRefWrite()
  {
...

    {
      AtomBitStorage<TestEventConfig> t(setup());
      {
        ...
        TestUlamRef ur2(24, 8, 0, t, 0);
        ur2.Write(0xcd);

        assert(ur.Read() == 0x43cd44);

        TestUlamRef ur2b(8, 32, 0, t, 0);
        ur2b.Write(0xfeedface);

        assert(ur.Read() == 0xedface);

        TestUlamRef ur3(0, 32, 0, t, 0);
        assert(ur3.Read() == 0x87feedfa);

        TestUlamRef ur4(32, 32, 0, t, 0);
        assert(ur4.Read() == 0xce332211);

        TestUlamRef ur5(64, 7, 0, t, 0);
  ...
  void UlamRef_Test::Test_UlamRefWriteLong()
  {
    ...
    }
    {
      ...
      TestUlamRef ur(8, 60, 0, t, 0);

      ur.WriteLong(HexU64(0xdeadbee,0xfd00df00));
      assert(ur.ReadLong() == HexU64(0xdeadbee,0xfd00df00));

      TestUlamRef ur0(0, 8, 0, t, 0);
      TestUlamRef ur1(8, 36, 0, t, 0);
      TestUlamRef ur2(44, 60-36, 0, t, 0);
...

    {
      ...
      TestUlamRef ur(31, 34, 0, t, 0);

      ur.WriteLong(-1L);

      TestUlamRef ur0(0, 32, 0, t, 0);
      TestUlamRef ur1(32, 32, 0, t, 0);
      TestUlamRef ur2(64, 4, 0, t, 0);
    ...
    }
    {
      ...
      TestUlamRef ur01(0, 64, 0, t, 0);
      TestUlamRef ur12(32, 68-32, 0, t, 0);

      TestUlamRef ur0(0, 32, 0, t, 0);
      TestUlamRef ur1(32, 32, 0, t, 0);
      TestUlamRef ur2(64, 71-64, 0, t, 0);
