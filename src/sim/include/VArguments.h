...
namespace MFM
{
   ...
   */
  typedef void (*VArgumentHandleValue)(const char*);
  ...
  private:
    ...
    struct VArg
    {
      ...
      VArg() : m_description(0), m_filter(0), m_value(0),
	       m_argsNeeded(false), m_appeared(false), m_function(0)
      {
   ...
   */
  void RegisterArgument(const char* description, const char* filter, VArgumentHandleValue func,
                        bool runFunc);
