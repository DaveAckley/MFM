...
namespace MFM{
  ...
  template<class EC> class Ui_Ut_r10181u; //forward //gcnl:UlamTypePrimitive.cpp:445
  ...
  struct Ui_Ut_10181u : public BitVectorBitStorage<EC, BitVector<8u> >
  {
    ...
    typedef BitVector<8> BV; //gcnl:UlamTypePrimitive.cpp:471
    typedef BitVectorBitStorage<EC, BV> BVS; //gcnl:UlamTypePrimitive.cpp:474

    const u32 read() const { return BVS::Read(0u, 8u); } //gcnl:UlamTypePrimitive.cpp:563
    void write(const u32& v) { BVS::Write(0u, 8u, v); } //gcnl:UlamTypePrimitive.cpp:613
    Ui_Ut_10181u() { } //gcnl:UlamTypePrimitive.cpp:487
    Ui_Ut_10181u(const u32 d) { write(d); } //gcnl:UlamTypePrimitive.cpp:495
    Ui_Ut_10181u(const Ui_Ut_10181u& other) : BVS() { this->write(other.read()); } //gcnl:UlamTypePrimitive.cpp:518
    Ui_Ut_10181u(const Ui_Ut_r10181u<EC>& d) { this->write(d.read()); } //gcnl:UlamTypePrimitive.cpp:527
    virtual const char * GetUlamTypeMangledName() const { return "Ut_10181u"; } //gcnl:UlamType.cpp:918
  };
} //MFM
...
namespace MFM{
  ...
  template<class EC> class Uq_10109210ByteSource10; //forward //gcnl:UlamTypeClassQuark.cpp:449
  template<class EC> class Ui_Uq_r10109210ByteSource10; //forward //gcnl:UlamTypeClassQuark.cpp:454
  ...
  struct Ui_Uq_10109210ByteSource10 : public BitVectorBitStorage<EC, BitVector<0> >
  {
    ...
    virtual const char * GetUlamTypeMangledName() const { return "Uq_10109210ByteSource10"; } //gcnl:UlamType.cpp:918
  };
} //MFM
...
namespace MFM{
  ...
  template<class EC> class Uq_10108ByteSink10; //forward //gcnl:UlamTypeClassQuark.cpp:449
  template<class EC> class Ui_Uq_r10108ByteSink10; //forward //gcnl:UlamTypeClassQuark.cpp:454
  ...
  struct Ui_Uq_10108ByteSink10 : public BitVectorBitStorage<EC, BitVector<0> >
  {
    ...
    virtual const char * GetUlamTypeMangledName() const { return "Uq_10108ByteSink10"; } //gcnl:UlamType.cpp:918
  };
} //MFM
