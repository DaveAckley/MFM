...
#define IS_OWNED_CONNECTION(X) ((X) - Dirs::EAST >= 0 && (X) - Dirs::EAST < 4)
  ...
  */
  ...
  public:
    ...
    const TileStagger TILE_STAGGER;
  ...
  public:
    ...
    typedef TileIterator< S, Tile<EC> > SiteInTileIterator;
    typedef TileIterator< const S, const Tile<EC> > ConstSiteInTileIterator;

    SiteInTileIterator beginAll() {
      return SiteInTileIterator(*this, 0, 0, 0);
    }
    ConstSiteInTileIterator beginAll() const {
      return ConstSiteInTileIterator(*this, 0, 0, 0);
    }

    SiteInTileIterator endAll() {
      return SiteInTileIterator(*this, 0, 0, TILE_HEIGHT);
    }
    ConstSiteInTileIterator endAll() const {
      return ConstSiteInTileIterator(*this, 0, 0, TILE_HEIGHT);
    }

    SiteInTileIterator beginOwned() {
      return SiteInTileIterator(*this, EVENT_WINDOW_RADIUS, EVENT_WINDOW_RADIUS, EVENT_WINDOW_RADIUS);
    }
    ConstSiteInTileIterator beginOwned() const {
      return ConstSiteInTileIterator(*this, EVENT_WINDOW_RADIUS, EVENT_WINDOW_RADIUS, EVENT_WINDOW_RADIUS);
    }

    SiteInTileIterator endOwned() {
      return SiteInTileIterator(*this, EVENT_WINDOW_RADIUS, EVENT_WINDOW_RADIUS, TILE_HEIGHT - EVENT_WINDOW_RADIUS);
    }
    ConstSiteInTileIterator endOwned() const {
      return ConstSiteInTileIterator(*this, EVENT_WINDOW_RADIUS, EVENT_WINDOW_RADIUS, TILE_HEIGHT - EVENT_WINDOW_RADIUS);
    }

    SiteInTileIterator begin(bool all) {
      if (all) return beginAll(); return beginOwned();
    }
    ConstSiteInTileIterator begin(bool all) const {
      if (all) return beginAll(); return beginOwned();
    }

    SiteInTileIterator end(bool all) {
