...
#include "Parity2D_4x4_tables.src"

}
#else /* -DWRITE_PARITY_TABLES */
// TO BUILD Parity2D_4x4_tables.src:
// touch Parity2D_4x4_tables.cpp;g++ -g -I ../include -DWRITE_PARITY_TABLES Parity2D_4x4.cpp -o Parity2D_4x4.elf;./Parity2D_4x4.elf > Parity2D_4x4_tables.src;rm -f Parity2D_4x4.elf
#include <stdio.h>
#include <stdlib.h>
...
namespace MFM {
  ...
  static void WriteParityTables(FILE * output) {
    fprintf(output,"%s", "  //// GENERATED TABLES: DO NOT EDIT\n  // (See Parity2D_4x4.cpp for generation and use of this file)\n\n");
